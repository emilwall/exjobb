...
Javascript är ett skriptspråk som främst används i webbläsare för att utföra mer komplicerad logik på klientsidan än vad som är möjligt med endast html och css. Det finns ett flertal testramverk för Javascript, men det är långt ifrån en självklarhet för utvecklare att utnyttja dem, för att de inte betraktar det som alls lika självklart att kod skriven i Javascript ska vara testad än övrig, mer back-end orienterad kod. Detta innebär att otestad kod sätts i produktion, som kan orsaka stora ekonomiska förluster i samband med driftstopp på grund av oupptäckta buggar och förhöjda kostnader i samband med vidareutveckling och underhåll av koden.
