...
%\usepackage[T1]{fontenc} % Rekommenderas vid byte till annat språk, men sabbar utseendet...
\usepackage{enumitem} % resume numbering in enumerations
\usepackage{geometry} % to change the page dimensions
\geometry{a4paper} % paper format
%\geometry{margin=3cm} % Change the margins to 3 cm all round
...
\author{Emil Wall}
%\date{} % Avkommentera för att visa dagens datum, eller skriv in datum som ska visas
...
%\begin{abstract}
%Sammanfattning här. Men specifikationen ska inte ha någon sammanfattning.
%\end{abstract}
