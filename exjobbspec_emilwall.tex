...
\textbf{Svensk titel:} Testning av Javascript - Fördelar och Tillvägagångssätt

\textbf{English:} \textit{\foreignlanguage{english}{Practices and Benefits of Javascript Testing}}
...
Att skriva tester för Javascript är inget nytt, det finns som sagt ett antal testramverk och det förekommer förstås att de används i projekt, men kunskapen om hur man på ett smidigt sätt kommer igång, hur man undviker att testerna blir icke-deterministiska och tidskrävande och vad det egentligen är man ska testa tycks vara sällsynt. Att sätta upp strukturen som krävs för att kunna skriva tester är en tröskel som de flesta Javascript-programmerare inte tar sig över och därmed går de miste om de vinster, såväl kortsiktiga som långsiktiga, som väl utförd testning ger.
...
Arbetet kommer att utföras i Valtechs lokaler i Stockholm, ett företag med cirka 150 anställda som ägnar sig åt konsultverksamhet primärt inriktad mot webben och agil utveckling.
