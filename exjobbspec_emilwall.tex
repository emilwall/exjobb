...
Arbetet kommer i första hand att utgå från kvalitativa metoder eftersom insikt i problemdomänen väger tyngre än vad generella slutsatser gör, för de mål som satts upp. Chansen att hitta de verkliga skälen till varför Javascript testas i så liten utsträckning ökar med öppna frågeställningar. Dessa metoder kommer att involvera litteraturstudier, intervjuer av gränssnittsprogrammerare vars arbete involverar kodande i Javascript och analys av kod och verktyg. Det kommer även att ingå praktiskt arbete vid utvärdering av de olika testramverken samt tillämpning av testning i ett projekt som författaren tidigare varit delaktig i på företaget.
