...
The testing community around JavaScript still has some ground to cover \cite[p.~xix]{Tddjs}. For Standard ML, a less known functional language, the situation is even more severe. This is evident when compared to other programming communities such as Ruby and Java. As illustrated by Mark Bates \cite{TestingStatistics}:
