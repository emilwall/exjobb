...
\begin{table}
  \centering
    ...
    \end{tabular}
  \caption{Time in ms to run 287 tests with JsTestDriver in headless and non-headless browsers. Average for PhantomJS was 246 ms, whereas Safari ran the tests in 186 ms on average -- 32 \% faster. The other non-headless browsers were roughly half as fast as PhantomJS.}
  \label{tab:testruns}
\end{table}
