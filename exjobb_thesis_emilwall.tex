...
There are consequences (good and bad) of testing JavaScript both from a short and from a longer perspective. The development process is affected, since the tests provide shorter feedback loops, can work as documentation and allow for new ways of communicating requirements with customers. The business value of the end result is likely to be affected, as well as the quality and maintainability of the code.
