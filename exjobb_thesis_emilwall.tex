...
The economic risk of untested JavaScript is especially high when the code is a prerequisite or direct part of the business critical operations, presumably increasingly common since more than 90 \% of today's websites use JavaScript\citep{BusinessJavascript}.
