...
The choice of looking at ML and JavaScript specifically was based on that they both have problems with testing culture, but for different reasons. During preliminary studies, many people seemed concerned about how to test JavaScript, so looking into it seemed like a good idea. The main reason to also look at testing of ML was that there was previously no BDD framework available for it, and that it is a functional language just like JavaScript, but typically used differently.
