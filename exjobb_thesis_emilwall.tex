...
Tests can serve as documentation for the code and forcing it to be written in a testable manner, which in itself tends to mean adherence to principles such as separation of concerns, and single responsibility\ref[p.~35-37]{Clean}. The documentation aspect serves a purpose both for the individual developer when working with the code, and for the product management when communicating with customers, since it can provide awareness of compatibility and progress \cite[question~38]{Ahnve}.
