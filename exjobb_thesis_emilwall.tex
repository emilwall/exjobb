...
\gls{ci} build with \newglossaryentry{autodeploy}{name={Automated Deployment}, description={Auto-deploy enables automatic release to test or production, possibly as part of a Continuous deployment strategy}}\gls{autodeploy}.
