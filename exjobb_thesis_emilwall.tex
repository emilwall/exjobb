...
A similar concept to Spike and Stabilise is to write markup without tests until a feature is needed that could use an API call. Then you write a test for it, and can start to work with that feature in a TDD fashion. \cite[question~30]{Ahnve}
