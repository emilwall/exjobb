...
Sebastien Salva and Patrice Laurencot has described how STS automata can be applied to describe asynchronous applications and generate test cases \cite{AutomatedAjax}.

Phillip Heidegger and Peter Thiemann has addressed the issue of type related errors by introducing JSConTest, a contract framework that enables guided random testing by specifying types and relations of the arguments and return value of functions \cite{ContractTesting}.
