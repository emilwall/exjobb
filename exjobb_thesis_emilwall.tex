...
\newglossaryentry{testing}{name={Testing}, text={testing}, description={Defined here as automated software testing, unless otherwise specified. Can refer to specification, validation and verification through unit testing, integration testing and/or system/acceptance testing}}
