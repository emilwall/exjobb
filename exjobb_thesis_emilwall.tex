...
The scope of this thesis is mainly limited to \emph{automated} testing of \gls{sml} and \emph{client side} \gls{js}. It strives to answer questions such as what the main problems within these two areas are, from an historical point of view and based on current state of events and developer cultures. What are the demands on tools and the people using them, for the situation to improve regarding testability, stability, maintainability, and productivity?
