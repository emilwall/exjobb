...
Before deciding on whether to do automated \gls{gui} testing or not, think carefully about how important the \gls{gui} and its cross browser compatibility is. If you feel that the exact appearance is irrelevant, then there is little sense in doing it. If you on the other hand feel that it would be valuable but have concerns about the technical aspects of it, you should not dismiss it too easily, since there are open source tools available such as PhantomCSS\footnote{\url{https://github.com/Huddle/PhantomCSS}}, Huxley\footnote{\url{https://github.com/facebook/huxley}}, Depicted\footnote{\url{https://github.com/bslatkin/dpxdt}} and Wraith\footnote{\url{https://github.com/BBC-News/wraith}}.
