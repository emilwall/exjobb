...
Writing your own testing framework is fun inspires to writing more tests, and is a good way to learn \gls{tdd}. However, it is probably best done as a hobby project, since existing frameworks are usually so good that writing a completely new one can not be justified towards a customer.
