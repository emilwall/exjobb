...
However, this leads to increased indentation level and verbosity, and limits any local (possibly shadowing as in the example) \gls{matcher} definition to be used only for the specified type, which is not always very convenient.
