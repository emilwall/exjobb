...
Standard ML, henceforth referred to as ML, is a strongly typed functional language used primarily in computer science and mathematical research. It has very little mutable state features and is formally specified in The Definition of Standard ML \cite{DefinitionStandardML}. Because ML is strongly typed, it has good static analysis capabilities, and since side effects are relatively rare, the complexity tends to stay reasonably low in many applications. However, every programming language can benefit from automated testing and ML have very little support for that.
