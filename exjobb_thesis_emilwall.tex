...
\section{Reasons for today's limited testing}

Compared to other programming communities such as Ruby and Java, there is little testing performed with JavaScript\cite{TestingStatistics}.
