...
\subsection{(ML0,JS1)Consequences of JavaScript testing}
...
\subsection{(ML,JS1)Covering Common and Advanced Cases}
...
Relevant books, articles and Internet sources were identified and skimmed, some were read through thoroughly. Over time, several new titles were published and some older literature was also included as the need became apparent. See \nameref{sec:previouswork} (section \ref{sec:previouswork}).

\subsection{(ML,JS)Framework Overview and Evaluation}

The following testing frameworks have been evaluated: % Move to appendix?
