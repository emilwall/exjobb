...
In \emph{Automatic Ajax application testing} \cite{AutomatedAjax} by Sebastien Salva and Patrice Laurencot, STS automata is applied to describe asynchronous applications and generate test cases.
