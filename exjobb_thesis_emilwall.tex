...
Several of the interviewees had experienced that application frameworks such as AngularJS are often uncompromising when it comes to using only a subset of the framework or using another testing framework than what the application framework was designed for, although CanJS might be an exception to this rule. \cite[question~22]{Ahnve}\cite[question~41]{Rovegard}
