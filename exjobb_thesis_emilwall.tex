...
\item Any favourites among the frameworks? Why?
\end{itemize}

\subsubsection{JavaScript in general}
\begin{itemize}
\item What is your opinion about JavaScript as a programming language compared to other languages you've used?
\item Do you feel productive when coding in JavaScript compared to other languages?
\item Do you feel that the code is easily made maintainable or is it hard to keep structure and readability as the application grows?
\item Do you think others tend to write "beautiful code" with JavaScript, or do you often see "ugly hacks" that are hard to understand and change?
\item What is your opinion on the object and prototype inheritance of JavaScript, do you use it?
\item Do you find it easy to make mistakes when coding in JavaScript?
\end{itemize}

\subsubsection{JavaScript testing experience}
\begin{itemize}
\item Have you written any unit tests when coding in JavaScript?
\item Have you written any end-to-end, UI or integration tests? Using selenium and other tools?
...
\begin{itemize}
\item Do you find it easy or hard to know what to test?
\item Do you find it easy or hard to know how to write the tests?
