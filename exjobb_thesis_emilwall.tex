...
The quality of JavaScript code has improved over the last few years, much thanks to new application frameworks (as mentioned in section~\ref{sec:appframeworks}) but also as a consequence of new ideas entering the JavaScript community. \cite[questions~12-15]{Ahnve}
