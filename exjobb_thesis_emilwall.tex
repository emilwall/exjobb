...
As a developer, you might miss the ''error loading file´´ message and that not all 36 tests were run, because the first line seems to say that everything went fine.
