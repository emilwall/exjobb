...
In JavaScript, tools for stubbing can be superfluous because you are able to manually replace functions with custom anonymous functions that have attributes for call assertion purposes.
