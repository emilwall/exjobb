...
\begin{table}
  \centering
    ...
    8 & 363 & 271 \\
    \end{tabular}
  \caption{Time in ms to run 287 tests with JsTestDriver in headless and non-headless browsers. Average for PhantomJS is 311 ms, whereas Safari runs the tests in 234 ms on average -- 33 \% faster.}
  \label{tab:testruns}
\end{table}
