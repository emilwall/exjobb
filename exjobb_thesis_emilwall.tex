...
By the time I found out about existing SML testing frameworks (apart from QCheck) I had already started to write my own. I wanted to use my insights from using JS testing frameworks such as Jasmine and Mocha to write a BDD framework which I would use in the Coursera MOC course Programming Languages. % Add references to the course, MOC explanation (perhaps in glossary?)
