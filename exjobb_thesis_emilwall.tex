...
\emph{Vad har du använt JavaScript i för sammanhang?}

Webb, alltså webbapplikationer.

\emph{Mycket frontend, eller backend också?}
...
\emph{Vad var det som gjorde dem avancerade då?}
...
\emph{Och det här gjorde ni testdrivet?}
...
\emph{Minns du hur ni testade det?}

JsTestRunner körde vi.

\emph{Jag tänker själva testerna, hur ni...}
...
\emph{Vad var det som fick er att göra det?}
...
\emph{Mm, och det var just för att få mer läsbara tester?}
...
\emph{Svårt att motivera gentemot kunden också kanske?}
...
\emph{Den här konferensen, var den under tiden som ni höll på med det här?}
...
\emph{Vad hade ni för nytta av testerna?}
...
\emph{Hur tror du att trenden var, för några år sen, har det förändrats nu med de nya verktygen?}
...
\emph{När jag började med mina efterforskningar så fick jag intrycket från allt jag läste att det inte testades mycket alls och sen när jag pratade med Johannes Edelstam så lät det på honom som att det börjar komma igång nu.}
...
\emph{Frågan är då ifall det har förändrats}
...
\emph{Vad är det du menar när du säger att tester ska vara meningsfulla?}
...
\emph{Det är väl också mycket det att man har möjlighet att specificera förutsättningarna: Given, When och de där.}
...
\emph{Hur uppnår man det, jag tänker att man behöver vara rätt så konkret när man skriver enhetstester? Exemplet tidigare om att uppdatera en användare i databasen är väl ganska bra i och för sig.}
...
\emph{Jag har bara provat Angular än så länge, jag ska nog kika lite på Can sen.}
...
\emph{Drog ni några lärdomar från projektet med kund Y?}
...
\emph{Så budskapet blir att det är bra att strukturera sin kod, men att man behöver se till att man vet varför man gör det.}

Ja, absolut.

\emph{Ett liknande resonemang är att det är bra att testa, men att man bör se till att man vet varför man gör det. Se till att alla vet varför.}
...
\emph{Vad är din syn på testning av JavaScript jämfört med andra språk, är det någon skillnad i hur du skriver tester?}
...
\emph{Har du upplevt att det varit svårare eller enklare?}
...
\emph{Och sen exploderade det med sådana ramverk.}

Ja, precis.

\emph{Vi pratade lite om ambitioner med testning tidigare, om man väljer att fokusera på integrationstester eller enhetstester, min fråga som jag hade här sen innan var: vilka brukar vara dina ambitioner när det kommer till testning?}
...
\emph{Så de första testerna du skriver är...?}
...
\emph{Det kan vara bra för att få en tydlig riktning kan jag tänka mig.}
...
\emph{Du nämnde att det kräver mycket disciplin. Det har ju lite att göra med ens personlighet som utvecklare, tror du att testning är något för alla? Om man inte är en sådan person som har den disciplinen.}
...
\emph{Vad är det man ser det på, rent konkret?}
...
\emph{Vilka ser du som de största riskerna med testning då? Om vi fortsätter på spåret om vilka som borde testa och inte. Det beror kanske lite på vilket projekt det är.}
...
\emph{I de projekt som du håller på med nu, skulle du vilja använda testning i alla?}
...
\emph{Jag har tänkt göra någon slags analys av ekonomiska aspekter av testning, hur mycket det lönar sig, men det är lite svårt att mäta tycker jag.}
...
\emph{Jag tänker att det här kan ha att göra med val av verktyg, att man behöver ta med i beräkningarna om de möjliggör testning på olika plattformar. Med Selenium kan man parallellisera upp sina tester på en grid och olika test drivers är olika kompetenta när det kommer till det där.}
...
\emph{Jag har tänkt att jag kanske borde intervjua personer med mindre koppling till valtech delvis av den anledningen.}
...
\emph{Som ska transformeras och positioneras så att de hamnar rätt, och fungera i alla operativsystem.}
...
\emph{Då gäller det att kunna säga vad det kostar.}
...
\emph{Det är intressant det här med kulturen, att det gick bra med kund X men att projektledaren med testarbakgrund hos mediekoncernen kunde ställa till med sådana problem.}

Ja, jag vet ju inte hur de gjorde med just rundade hörn, men...

\emph{Nej men just med processerna vid release.}
...
\emph{Det är ändå intressant, just kulturen och det tänker jag nog skriva om i uppsatsen att folk behöver vara överens om hur mycket man ska testa, vad det är man ska testa, så att det inte blir konflikter inom teamet och med kunden.}
...
\emph{Vad skulle du ge för tips till någon som tycker att det är riktigt svårt, som menar på att det inte går att testa gränssnitt? Att det bara blir långsamt och jobbigt?}
...
\emph{Då tycker jag att vi avslutar med den tanken.}
